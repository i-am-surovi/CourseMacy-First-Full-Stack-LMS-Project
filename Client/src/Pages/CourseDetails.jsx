...
const CourseDetails = () => {
  ...
  useEffect(()=>{
    const getCourseLecture = async()=>{
      try {
          const res = await axios.get(`https://coursemacy.onrender.com/course/${courseId}/lecture`,
      ...
      <Card className="max-w-7xl rounded-md mx-auto bg-white shadow-md pt-5 mt-14">
        ...
        <div className='p-6'>
          <div className='flex flex-col lg:flex-row lg:space-x-8'>
            ...
            <div>
              ...
              <div className='mt-1'>
                <p className='text-2xl font-bold text-gray-800'><FontAwesomeIcon icon={faBangladeshiTakaSign} className="mr-1" />{selectedCourse.coursePrice}</p>
                <p className='text-gray-500 line-through'><FontAwesomeIcon icon={faBangladeshiTakaSign} className="mr-1" />{selectedCourse.coursePrice+100}</p>
              </div>
            ...
            <div className='w-full lg:w-1/2'>
              <Card>
                <CardContent className="p-4 flex flex-col"> 
                  ...
                  <p>Get a sneak peek inside this course! This short preview highlights key learning areas, introduces the instructor, and showcases the engaging content you can expect. Discover how this course can help you achieve your goals.</p>
                </CardContent>
        ...
        <div className='p-6'>
          ...
          <div className='flex items-center space-x-4'>
            <img src={selectedCourse.creator.photoUrl} 
            alt="instructor"
